var theme =0;
  ...
  function changeTheme() { 
    ...
    if (theme === 4) {
      body.style.backgroundColor = '#dcd0ff';
      body.style.color = 'black';
    }
  
    theme ++;
    if (theme >= 5)  // prevents errors of going over 4 styles and loops back to the first
    {
      theme = 0;
    }
...
function showFeedback(){
  ...
  // body.innerHTML += '<div><center><img alt="That is correct - well done" src="gold rosette 2.png"></center></div> <br>';
